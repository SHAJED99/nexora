...
- **NFR-PERF-001**: The application should remain responsive during synchronization, file transfer, route migration, background processing, and database operations. *(traces_to: BRD §62.3)* **[No numeric target — proven by mechanism-level criteria, as NFR-BATT-001 and NFR-SCALE-001 are: EARS-COMM-17 (one grouped query, not N+1), EARS-COMM-19 (write bursts coalesce), EARS-COMM-36 and EARS-COMM-37 (a resolved plaintext is never decrypted twice). Human decision, 2026-09-22.]**
