...
| `make lessons` | ✅ | `33 lessons · 16 promoted · 3 awaiting promotion` (was crashing before 2026-09-24). Was 30 until `L-backend-006`, `L-infra-003` and `L-qa-002` were recovered from an uncommitted retro worktree; all three are `recurrence: 1`, so the promotion candidates are unchanged. The third candidate is `L-process-014`, written on **2026-09-02**; it became a candidate on 2026-09-24, when `4dd1fe2` (#312) raised its `recurrence:` to 2. |
