...
| `make lessons` | ✅ | `34 lessons · 16 promoted · 3 awaiting promotion` (was crashing before 2026-09-24). Was 30 on `da4459b`: `L-backend-006`, `L-infra-003` and `L-qa-002` were recovered from an uncommitted retro worktree (#317), and `L-infra-004` was written for the H8 episode (#316 and its follow-up). All four are `recurrence: 1`, so the promotion candidates are unchanged at three. The third candidate is `L-process-014`, written on **2026-09-02**; it became a candidate on 2026-09-24, when `4dd1fe2` (#312) raised its `recurrence:` to 2. |
