...
| `make lessons` | ✅ | `35 lessons · 16 promoted · 4 awaiting promotion` (was crashing before 2026-09-24). Was 30 on `da4459b`: `L-backend-006`, `L-infra-003` and `L-qa-002` were recovered from an uncommitted retro worktree (#317), `L-infra-004` was written for the H8 episode (#316 and its follow-up), and `L-process-020` for the claim-sourcing failures that ran through the whole session. Four of the five are `recurrence: 1`; `L-process-020` is `recurrence: 6`, counted per instance following `L-process-011`'s precedent, so it is a **fourth** promotion candidate and points at the hook rung. Promotion itself is the 🧍 `retro_promotions` gate and has not been taken. The third candidate is `L-process-014`, written on **2026-09-02**; it became a candidate on 2026-09-24, when `4dd1fe2` (#312) raised its `recurrence:` to 2. |
