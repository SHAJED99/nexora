...
**Status:** in progress · **Started:** 2026-08-29 · **Completed:** — · **Progress:** 8/13 tasks (+ B01 bug fixed)
...
- [ ] E06-T08 · Delivery acknowledgements (Accepted/Delivered/Read) · todo · backend · builder · should/P2 · M · depends on T07 (merged); contract amended: also retrofits `inbound_pipeline.dart`/`prekey_exchange.dart` for a keyed control-handler seam (OQ-E06-T08-2)
