...
**Status:** in progress — 4/6 tasks done and merged into `epic_14` (T01,
T02, T05, T06); T03 remains `blocked` on a human key-infrastructure
decision (`OQ-E14-T03-1`); T04 unlocked (its own dependency, T02, is now
merged) and ready to dispatch. · **Started:** 2026-09-05 ·
**Completed:** — · **Progress:** 4/6 tasks done
