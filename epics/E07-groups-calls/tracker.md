...
| E07-T15 | Group create screen - build `/groups/new` against its approved contract | frontend | M | must | T03, T08 | done - builder (opus) -> reviewer (sonnet) - APPROVE, no findings - design-verify PASS 16/16 - 1605 tests green |
