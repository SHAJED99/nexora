...
- [ ] E04-B27 · Small defects from the 2026-09-15 audit and live testing: stale Dashboard latency next to "No peers nearby", re-delivered PreKey messages counted as undecryptable, `stop()` race, silent startup-task failures, non-atomic one-time-prekey replenish · in_review · orchestrator (opus). Four falsifications, 1568/1568.
