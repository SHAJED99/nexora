...
- [ ] E04-B20 · Group messages were decrypted twice (receive time, discarded; preview time, re-derived), the same defect class E04-B18 fixed for 1:1 · in_review · orchestrator (opus). Body now persisted in `plaintext_payload` at receive and send; group preview reads it first. Three falsifications, 1563/1563.
