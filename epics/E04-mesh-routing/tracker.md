...
- [ ] E04-B30 · E04-T07's bonded-cache refresh ran an SDP query against every bonded SPP-capable device (headphones, printers, laptops), each absent one timing out ~5 s in series on every listener start (live, Pixel 8 Pro) · in_review · orchestrator (opus). Refresh now limited to bonded devices whose Bluetooth major class is PHONE or COMPUTER.
