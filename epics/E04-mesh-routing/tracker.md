...
- [ ] E04-B16 · Multi-hop relay could never route an identity-addressed packet (routing only knows link ids) · in_review · orchestrator (opus). Human decision 2026-09-15: routing alias map. `RoutingEngine` resolves an announced identity to its link, fed only for trusted/allowed peers, ambiguous claims resolve to nothing. Three falsifications, 1569/1569.
