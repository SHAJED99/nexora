...
status: in-progress  # 2026-09-16: reopened for E04-B35 (native keepalive / dead-link detection, planned from OQ-E04-B34-2). Before that, 2026-09-15: every task and bug done and merged into development (last: E04-B34, #280). Unticked boxes remain and are carried forward, not hidden. (a) Earlier on-device checks never completed: E04-T06 excluding a real non-Nexora accessory (OQ-E04-T06-1), E04-B22's UUID-filter fallback path (OQ-E04-B22-1), E04-B13's original live pass (superseded in practice by the E04-B17/B18 live deliveries), E04-B06's deferred on-device re-test and E04-B08's unconfirmed bonded-name-match path (both exercised in practice by the later live bond/connect/deliver passes of E04-B10, E04-B17 and 2026-09-15, not re-run in isolation), E04-B17's "not fully closed" decrypt box (resolved via E04-B18, done), the manual-check and template process boxes (`Squash-merged to epic_04`, `Human verified`) in E04-T01–T05, E04-B10's unfilled template checklist line and its 2026-09-12 in-log rejected-pairing box (superseded by the 2026-09-15 live check recorded in the same file), and E04-B33's live box, which is marked not required by design. (b) Hardware gaps from the 2026-09-15 close-out pass, each recorded in its own task file: E04-B10 F2 (post-bond settle/retry; unattended pairing prompts fail on the Redmi, OQ-E04-B10-2), E04-B28 latency-cleared-by-lost-event box, E04-B31 stale-cache branch (not reproducible on these phones), E04-T07 never-known peer as a new Discover row (needs a third device), E04-B34 live box (the Pixel's stack reported no link loss within 40 s, OQ-E04-B34-2), E04-B32 retry branch (no collision occurred live).
type: feature
