...
class AppDatabase extends _$AppDatabase {
  ...
  MigrationStrategy get migration => MigrationStrategy(
    onCreate: (m) async {
      ...
      // E11-T04: `device_revocations` needs no default row -- a fresh
    ...
    onUpgrade: (m, from, to) async {
      ...
      if (from < 17) {
        ...
        // §3).
        //
        // Renumbered from E11's own original `from < 15` to `from < 17`
        // during the epic_11 -> development merge (2026-09-05): E09 and
        // E10 each independently claimed v15/v16 against an earlier
        // development baseline that predated this table. The table
  ...
  Future<int> createDeviceIdentity(String deviceId) {
    return into(
      deviceIdentities,
    ).insert(DeviceIdentitiesCompanion.insert(deviceId: deviceId));
  }
